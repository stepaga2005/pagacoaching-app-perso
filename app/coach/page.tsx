...
function Dashboard({ coachId, onNavTo }: { coachId: string | null; onNavTo: (tab: string) => void }) {
...
type Groupe = { id: string; nom: string; couleur: string; coach_id?: string }
